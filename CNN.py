    ...
    with tf.Session() as sess:
        ...
        for each in type:
            ...
            for idx, vf in enumerate(video_filename):
                ...
                # in case of not enough images
                if len(images_list) < num_of_image_per_video:
                    print ('Skip' + str(idx + 1) + 'videos..')
                    continue
                else:
            ...
            print('total valid videos: ' + str(valid_videos))
            ...
            txt.write(TIME + ':       ' + str(valid_videos) + '\r\n')
            txt.close()
